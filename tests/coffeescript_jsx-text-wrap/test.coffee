...
expression_does_not_break =
  <div>texty text text text text text text text text text text text text {this.props.type} </div>

br_triggers_expression_break =
  <div><br />
  text text text text text text text text text text text text {this.props.type} </div>
